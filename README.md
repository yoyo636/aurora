...
curl -L -o Aurora-Installer-v3.3.0.pkg https://github.com/yoyo636/aurora/releases/download/v3.3.0/Aurora-Installer-v3.3.0.pkg
installer -pkg Aurora-Installer-v3.3.0.pkg -target /
...
| `aurora debug --incremental` | **(v3.3.0)** 增量计算调试:依赖图导出 / 重算统计 / 脏标记查看 |
| `aurora --version` | 版本信息 |
...
# v3.2.0 全栈开发特性(Web 框架 / ORM / CLI / TUI / Git 绑定 / 代码生成器 / 语言级增强),
# 以及 v3.3.0 增量计算引擎(source/live/transact / 拉模式重算 / 哈希短路 / 编译期纯度检查 / 循环依赖检测)
```
